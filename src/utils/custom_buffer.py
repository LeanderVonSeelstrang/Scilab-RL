...
class CustomRolloutBuffer(BaseBuffer):
    ...
    def reset(self) -> None:
        ...
        self.rewards_of_env = np.zeros((self.buffer_size, self.n_envs), dtype=np.float32)
    ...
    def add(
        ...
        :param action: Action
        :param reward:
        :param reward_of_env: Intermediate reward of just the next step without changes through forward model prediction
        ...
        self.rewards_of_env[self.pos] = np.array(reward_of_env).copy()
    ...
    ) -> CustomRolloutBufferSamples:  # type: ignore[signature-mismatch]
        data = (
            self.observations[batch_inds],
            self.next_observations[batch_inds],
            self.actions[batch_inds],
            self.rewards[batch_inds],
            self.rewards_of_env[batch_inds],
...
class CustomDictRolloutBuffer(CustomRolloutBuffer):
    """
    ...
    def add(  # type: ignore[override]
        ...
        self.rewards_of_env[self.pos] = np.array(reward_of_env)
    ...
    def _get_samples(  # type: ignore[override]
        ...
        return CustomDictRolloutBufferSamples(
            ...
            rewards_of_env=self.to_torch(self.rewards_of_env[batch_inds].flatten()),
